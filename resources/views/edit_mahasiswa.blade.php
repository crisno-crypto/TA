    ...
    <div id="wrapper">
        ...
        <div class="navbar-default sidebar" role="navigation">
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="../../mahasiswa" class="waves-effect"><i class="fa a-fw" aria-hidden="true"></i>MAHASISWA</a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="../../inputnilai" class="waves-effect"><i class="fa fa-columns fa-fw" aria-hidden="true"></i>Input Nilai</a>
                    </li>                    
            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Edit Data Mahasiswa</h4> </div>
                        ...
                        <div class="white-box">
                          ...
                          {{ csrf_field() }}
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                    <input type="hidden" name="id_mhs" placeholder="" class="form-control form-control-line" value="{{ $mhs->id_mhs }}" readonly>
                                        <input type="text" name="nim" placeholder="" class="form-control form-control-line" value="{{ $mhs->nim }}" readonly> </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">Nama</label>
                                    <div class="col-md-12">
                                        <input type="text" name="nama" placeholder="" class="form-control form-control-line" value="{{ $mhs->nama }}"> </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">Kelas</label>
                                    <div class="col-md-12">
                                        <input type="hidden" name="kelas" placeholder="" class="form-control form-control-line" value="{{ $mhs->id_kelas }}"> </div>
                                    <div class="col-md-12">
                                        <input type="text" placeholder="" readonly class="form-control form-control-line" value="{{ $mhs->kelas }}"> </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" placeholder="" class="form-control form-control-line" name="jk" value="{{ $mhs->jk }}"> </div>
                                </div>
                                <div class="form-group">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" placeholder="" class="form-control form-control-line" value="{{ $mhs->tlp }}" name="tlp"> </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">Alamat</label>
                                    <div class="col-md-12">
                                          <input type="text" placeholder="" class="form-control form-control-line" value="{{ $mhs->alamat }}" name="alamat">
                                        </div>
                                </div>                                
                                <div style="padding-left: 870px" class="form-group">
                                    <div class="col-sm-12">
