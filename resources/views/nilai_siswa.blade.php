       ...
       <nav class="navbar navbar-default navbar-static-top m-b-0">
        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <!-- /.row -->
                <!-- .row -->
                <form action="/nilai_siswa/cari" method="GET">
  <input type="text" name="cari" placeholder="Cari nilai .." value="{{ old('cari') }}">
  <input type="submit" value="CARI">
  <a href="/nilai_siswa" class="btn btn-primary">Reset</a>
</form>
              <table id="example1" class="table table-bordered table-striped">
                ...
                @foreach($mahasiswa as $datam)
                <tr>
                <td> {{ $datam->nim }}</td>
                <td> {{ $datam->nama }}</td>
                <td> {{ $datam->kelas }}</td>
                <td>
                    <a href="/semua_nilai_mahasiswa/{{$datam->id_kelas}}/{{$datam->id_mhs}}"><button class="btn btn-primary"><i class="fa fa-edit"></i> Pilih</button></a>
                </td>
              </tr>
              @endforeach
              </table>
