            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Edit Data Matakuliah</h4> </div>
                        ...
                        <form action="/matakuliah/update" method="post">
                          {{ csrf_field() }}
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="hidden" name="id_mk" placeholder="" class="form-control form-control-line" value="{{ $matakuliah->id_mk }}" readonly>
                                        <input type="text" name="kd_mk" placeholder="" class="form-control form-control-line" value="{{ $matakuliah->kd_mk }}" readonly> </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">Kelas</label>
                                    <div class="col-md-12">
                                        <input type="hidden" placeholder="" name="kelas" class="form-control form-control-line" value="{{ $matakuliah->kelas }}"> </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">Nama Dosen</label>
                                    <div class="col-md-12">
                                        <input type="text" placeholder="" name="kd_dosen" class="form-control form-control-line" value="{{ $matakuliah->kd_dosen }}"> </div>

                                <div class="form-group">
                                    <label class="col-md-12">Semester</label>
                                    <div class="col-md-12">
                                        <input type="text" placeholder="" name="semester" class="form-control form-control-line" value="{{ $matakuliah->semester }}"> </div>
                                </div>
