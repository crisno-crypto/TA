            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Tambah Data Kelas</h4> </div>
                    
                    <div>
                    <div class="white-box">
                         <form action="/kelas/tambahdata" method="post">
                          {{ csrf_field() }} 
                        </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <select class="form-control form-control-line" name="konsentrasi">
                                            <option>Informatika Komputer</option>
                                            <option>Administasi Bisnis</option>
                                            <option>Administrasi Perpajakan</option>
                                            <option>Administrai Perkantoran</option>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                         <input type="text" placeholder="" class="form-control form-control-line" name="kelas"></div>
                                </div>                               
