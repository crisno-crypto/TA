            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Ubah Data Kelas</h4> </div>
                    ...
                    <div>
                        ...
                        <form action="/kelas/update" method="post">
                          {{ csrf_field() }}
                                ...
                                <input type="hidden" name="id_kelas" placeholder="" class="form-control form-control-line" value="{{ $kelas->id_kelas }}" readonly>
                                    <label class="col-md-12">Prodi</label>
                                    <div class="col-md-12">
                                        <select class="form-control form-control-line" name="prodi">
                                            <option>Manajemen Informatika</option>
                                            <option>Administasi Bisnis</option>
                                            <option>Administrasi Pemerintahan</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">Konsentrasi</label>
                                    <div class="col-md-12">
                                        <input type="text" placeholder="" name="konsentrasi" class="form-control form-control-line" value="{{ $kelas->konsentrasi }}"> </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">Kelas</label>
                                    <div class="col-md-12">
                                        <input type="text" placeholder="" name="kelas" class="form-control form-control-line" value="{{ $kelas->kelas }}"> </div>
