            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Edit Data Dosen</h4> </div>
                        ...
                        <form action="/dosen/update" method="post">
                          {{ csrf_field() }}
                                ...
                                <div class="form-group">
                                    <label class="col-md-12">Nomor Induk Dosen</label>
                                    <div class="col-md-12">
                                        <input type="hidden" name="id_dosen" placeholder="" class="form-control form-control-line" value="{{ $dosen->id_dosen }}" readonly>
                                        <input type="text" name="nid" placeholder="" class="form-control form-control-line" value="{{ $dosen->nid }}" readonly> </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">Nama</label>
                                    <div class="col-md-12">
                                        <input type="text" placeholder="" name="nama" class="form-control form-control-line" value="{{ $dosen->nama }}"> </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">Jenis Kelamin</label>
                                    <div class="col-md-12">
                                        <input type="text" placeholder="" name="jk" class="form-control form-control-line" value="{{ $dosen->jk }}"> </div>

                                <div class="form-group">
                                    <label class="col-md-12">Alamat</label>
                                    <div class="col-md-12">
                                        <input type="text" placeholder="" name="alamat" class="form-control form-control-line" value="{{ $dosen->alamat }}"> </div>
                                </div>
                                 <div class="form-group">
                                    <label class="col-md-12">Nomor Telphone</label>
                                    <div class="col-md-12">
                                        <input type="text" placeholder="" name="tlp" class="form-control form-control-line" value="{{ $dosen->tlp }}"> </div>
                                </div>
